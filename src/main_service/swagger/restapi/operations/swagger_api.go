...
func NewSwaggerAPI(spec *loads.Document) *SwaggerAPI {
	return &SwaggerAPI{
		...
		TodosAddHandler: todos.AddHandlerFunc(func(params todos.AddParams) middleware.Responder {
			return middleware.NotImplemented("operation todos.Add has not yet been implemented")
		}),
		TodosDestroyHandler: todos.DestroyHandlerFunc(func(params todos.DestroyParams) middleware.Responder {
			return middleware.NotImplemented("operation todos.Destroy has not yet been implemented")
		}),
		TodosFindHandler: todos.FindHandlerFunc(func(params todos.FindParams) middleware.Responder {
			return middleware.NotImplemented("operation todos.Find has not yet been implemented")
		}),
		TodosUpdateHandler: todos.UpdateHandlerFunc(func(params todos.UpdateParams) middleware.Responder {
			return middleware.NotImplemented("operation todos.Update has not yet been implemented")
		}),
	}
}
...
type SwaggerAPI struct {
	...
	// TodosAddHandler sets the operation handler for the add operation
	TodosAddHandler todos.AddHandler
	// TodosDestroyHandler sets the operation handler for the destroy operation
	TodosDestroyHandler todos.DestroyHandler
	// TodosFindHandler sets the operation handler for the find operation
	TodosFindHandler todos.FindHandler
	// TodosUpdateHandler sets the operation handler for the update operation
	TodosUpdateHandler todos.UpdateHandler
...
func (o *SwaggerAPI) Validate() error {
	...
	if o.TodosAddHandler == nil {
		unregistered = append(unregistered, "todos.AddHandler")
	}
	if o.TodosDestroyHandler == nil {
		unregistered = append(unregistered, "todos.DestroyHandler")
	}
	if o.TodosFindHandler == nil {
		unregistered = append(unregistered, "todos.FindHandler")
	}
	if o.TodosUpdateHandler == nil {
		unregistered = append(unregistered, "todos.UpdateHandler")
	}
...
func (o *SwaggerAPI) initHandlerCache() {
	...
	o.handlers["POST"][""] = todos.NewAdd(o.context, o.TodosAddHandler)
	if o.handlers["DELETE"] == nil {
		o.handlers["DELETE"] = make(map[string]http.Handler)
	}
	o.handlers["DELETE"]["/{id}"] = todos.NewDestroy(o.context, o.TodosDestroyHandler)
	...
	o.handlers["PUT"]["/{id}"] = todos.NewUpdate(o.context, o.TodosUpdateHandler)
}
