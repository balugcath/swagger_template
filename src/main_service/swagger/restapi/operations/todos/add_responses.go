...
func (o *AddCreated) WithPayload(payload *models_server.Item) *AddCreated {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the add created response
func (o *AddCreated) SetPayload(payload *models_server.Item) {
	o.Payload = payload
}
...
func (o *AddDefault) WithPayload(payload *models_server.Error) *AddDefault {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the add default response
func (o *AddDefault) SetPayload(payload *models_server.Error) {
	o.Payload = payload
}
